...
import { BotaoMenu/*, BotaoMenuBC, BotaoMenuBE, BotaoMenuBR, BotaoMenuBS, BotaoMenuBT, BotaoMenuBY, */, ContainerBotoesMenu, ImgIcon, LblBotao } from './styles';
        ...
        <>
            <ContainerBotoesMenu>
                ...
                <BotaoMenu gridArea={'BY'} style={{paddingTop:"20px"}}>
                    <LblBotao style={{fontWeight:'bold'}}>
                        YOUR
                    </LblBotao>
                    <div>
